...
namespace XGraph
{
    abstract class MasterNode : BaseNode, IMasterNode, IHasSettings
    {
        ...
        where T : class, ISubShader
    {
        ...
        {
            m_SubShaders = SerializationHelper.Deserialize<T>(m_SerializableSubShaders, XGraphUtil.GetLegacyTypeRemapping());
